...
@Component({
  selector: 'app-case-generic',
  templateUrl: './case-generic.component.html',
  styleUrls: ['./case-generic.component.css']
})
export class CaseGenericComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CaseGenericComponent>,
